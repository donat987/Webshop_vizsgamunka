            ...
            <div class='container'>
                <div class='row'>
                    ...
                    <div class='col-lg-5 ml-auto'>
                        ...
                        @endif
                        {{-- <p>Márka: " . $row['marka'] . "</p>
                    <p>Gyümölcs: " . $row['gyumolcs'] . "</p>
                    <p>Mennyiség: " . $row['mennyiseg'] . " l.</p>
                    <p>" . $row['leiras'] . "</p>
