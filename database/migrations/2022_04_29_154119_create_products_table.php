...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->text('vintage');
            $table->unsignedBigInteger('capacityID');
            ...
            $table->foreign('capacityID')->references('id')->on('capacities')->onDelete('cascade')->onUpdate('cascade');
            ...
            $table->foreign('ratingID')->references('id')->on('ratings')->onDelete('cascade')->onUpdate('cascade');
